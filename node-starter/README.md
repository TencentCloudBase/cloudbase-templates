...
这个目录是基于云开发的一个 [Node](https://nodejs.org/zh-cn/) 应用示例，包含 Node + 云函数，可以基于 **[CloudBase Framework](https://gitee.com/TencentCloudBase/cloudbase-framework)** 框架将项目一键部署到云开发环境
